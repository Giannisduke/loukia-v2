            ...
            FWP.hooks.addAction('facetwp/loaded', function() {
                ...
                $.each(FWP.facets, function(key, val) {
                    ...
                    $.each(choices, function(idx, choice) {
                        values += '<li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem" class="breadcrumb-item facetwp-selection-value" data-value="' + choice.value + '">' + FWP.helper.escape_html(choice.label) + '</li>';
                    });
