...
final class FacetWP_Helper
{
    ...
    function get_facet_types() {
        ...
        $types = [
            ...
            'checkboxes_custom'    => 'Facetwp_Facet_Checkboxes_Custom',
            'checkboxes_custom_icon'    => 'Facetwp_Facet_Checkboxes_Custom_icon',
            ...
            'slider_indicators'        => 'FacetWP_Facet_Slider_Indicators',
