...
class Facetwp_Facet_Checkboxes_Custom_icon extends FacetWP_Facet
{

    function __construct() {
        $this->label = __( 'Checkboxes Custom Icon', 'fwp' );
    }
    ...
    function render( $params ) {
        ...
        foreach ( $values as $key => $result ) {
            ...
            $output .= '<div class="facetwp-checkbox protection ' . $selected . '" data-value="' . esc_attr( $result['facet_value'] ) . '">';
            $output .= '<span class="level-'. esc_attr( $result['facet_value'] ) .'"></span>';
            $output .= '</div>';
        }
    ...
    function render_hierarchy( $params ) {
        ...
        foreach ( $values as $result ) {
            ...
            //$output .= '<h3>' . esc_html( $result['facet_display_value'] ) . '</h3><span class="facetwp-counter">(' . $result['counter'] . ')</span>';
            $output .= '</div>';
