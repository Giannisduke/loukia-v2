 ...
 * @version     0.1
 */
use DhlVendor\DHL\Entity\EA\KnownTrackingRequest as Tracking;
use DhlVendor\DHL\Client\Web as WebserviceClient;
require __DIR__ . '/../../init.php';
// DHL Settings
$dhl = $config['dhl'];
// Test a tracking request using DHL XML API
$request = new \DhlVendor\DHL\Entity\EA\KnownTrackingRequest();
...
$result = new \DhlVendor\DHL\Entity\EA\TrackingResponse();
