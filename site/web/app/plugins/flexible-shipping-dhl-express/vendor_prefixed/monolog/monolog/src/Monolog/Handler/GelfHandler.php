...
use DhlVendor\Gelf\IMessagePublisher;
use DhlVendor\Gelf\PublisherInterface;
use DhlVendor\Gelf\Publisher;
...
class GelfHandler extends \DhlVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($publisher, $level = \DhlVendor\Monolog\Logger::DEBUG, $bubble = \true)
    {
        parent::__construct($level, $bubble);
        if (!$publisher instanceof \DhlVendor\Gelf\Publisher && !$publisher instanceof \DhlVendor\Gelf\IMessagePublisher && !$publisher instanceof \DhlVendor\Gelf\PublisherInterface) {
