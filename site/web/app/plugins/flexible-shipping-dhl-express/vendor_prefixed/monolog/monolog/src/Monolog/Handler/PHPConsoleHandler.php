...
use DhlVendor\PhpConsole\Handler;
...
class PHPConsoleHandler extends \DhlVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     * @throws Exception
     */
    public function __construct(array $options = array(), \DhlVendor\PhpConsole\Connector $connector = null, $level = \DhlVendor\Monolog\Logger::DEBUG, $bubble = \true)
    {
    ...
    private function initConnector(\DhlVendor\PhpConsole\Connector $connector = null)
    {
        if (!$connector) {
