...
class PushoverHandler extends \DhlVendor\Monolog\Handler\SocketHandler
{
     ...
     */
    public function __construct($token, $users, $title = null, $level = \DhlVendor\Monolog\Logger::CRITICAL, $bubble = \true, $useSSL = \true, $highPriorityLevel = \DhlVendor\Monolog\Logger::CRITICAL, $emergencyLevel = \DhlVendor\Monolog\Logger::EMERGENCY, $retry = 30, $expire = 25200)
    {
