 ...
 */
class Logger implements \Psr\Log\LoggerInterface, \DhlVendor\Monolog\ResettableInterface
{
    /**
     ...
     * @return $this
     */
    public function pushHandler(\DhlVendor\Monolog\Handler\HandlerInterface $handler)
    {
    ...
    {
        if (!$this->handlers) {
            $this->pushHandler(new \DhlVendor\Monolog\Handler\StreamHandler('php://stderr', static::DEBUG));
        }
