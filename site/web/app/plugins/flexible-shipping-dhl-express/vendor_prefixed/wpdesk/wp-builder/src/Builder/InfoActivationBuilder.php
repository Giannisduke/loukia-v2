 ...
 */
class InfoActivationBuilder extends \DhlVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
    ...
    public function build_plugin()
    {
        ...
        if ($this->plugin instanceof \DhlVendor\WPDesk\PluginBuilder\Plugin\ActivationAware && $this->is_active) {
            $this->plugin->set_active();
        }
        return $this->plugin;
    }
    public function store_plugin(\DhlVendor\WPDesk\PluginBuilder\Storage\PluginStorage $storage)
    {
