 ...
 */
class GenerateWooCommerce extends \DhlVendor\Codeception\Command\GenerateTest implements \DhlVendor\Codeception\CustomCommandInterface
{
    /**
    ...
    {
        return new \DhlVendor\WPDesk\Codeception\Command\WooCommerceTestGenerator($config, $class);
    }
    /**
     * Execute command.
     *
