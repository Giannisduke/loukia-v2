...
use DhlVendor\Composer\Downloader\FilesystemException;
 ...
 */
class CreateCodeceptionTests extends \DhlVendor\WPDesk\Composer\Codeception\Commands\BaseCommand
{
    use SedTrait;
    /**
     * Configure command.
    ...
    {
        if (!\copy($source, $dest)) {
            throw new \DhlVendor\Composer\Downloader\FilesystemException($exceptionMessage);
        }
    }
    /**
