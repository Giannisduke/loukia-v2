...
use DhlVendor\Symfony\Component\Console\Input\InputArgument;
 ...
 */
class RunCodeceptionTests extends \DhlVendor\WPDesk\Composer\Codeception\Commands\BaseCommand
{
    const SINGLE = 'single';
    const FAST = 'fast';
    ...
    {
        parent::configure();
        $this->setName('run-codeception-tests')->setDescription('Run codeception tests.')->setDefinition(array(new \DhlVendor\Symfony\Component\Console\Input\InputArgument(self::SINGLE, \DhlVendor\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'Name of Single test to run.', 'all'), new \DhlVendor\Symfony\Component\Console\Input\InputArgument(self::FAST, \DhlVendor\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'Fast tests - do not shutdown docker-compose.', 'slow'), new \DhlVendor\Symfony\Component\Console\Input\InputArgument(self::WOOCOMMERCE_VERSION, \DhlVendor\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'WooCommerce version to install.', '')));
    }
    /**
     * Execute command.
     *
     ...
     * @return void
     */
    protected function execute(\DhlVendor\Symfony\Component\Console\Input\InputInterface $input, \DhlVendor\Symfony\Component\Console\Output\OutputInterface $output)
    {
