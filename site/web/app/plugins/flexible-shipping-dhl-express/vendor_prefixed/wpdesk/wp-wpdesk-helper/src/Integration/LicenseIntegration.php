...
use DhlVendor\WPDesk\License\Page\LicensePage;
 ...
 */
class LicenseIntegration implements \DhlVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /** @var LicensePage */
    ...
    {
        $plugin_registry = new \DhlVendor\WPDesk\License\InstalledPlugins();
        $this->license_page = new \DhlVendor\WPDesk\License\Page\LicensePage($plugin_registry);
