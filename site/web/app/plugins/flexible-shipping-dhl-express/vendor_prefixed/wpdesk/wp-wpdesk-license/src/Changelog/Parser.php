...
namespace DhlVendor\WPDesk\License\Changelog;

use ArrayObject;
use DhlVendor\WPDesk\License\Changelog\Parser\Line;
/**
 * Can parse changelog.
 *
...
class Parser
{
    ...
    private function get_lines()
    {
        ...
        return \array_map(function ($line) {
            return new \DhlVendor\WPDesk\License\Changelog\Parser\Line($line);
