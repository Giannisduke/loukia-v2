...
class WPDesk_Helper_List_Table extends \WP_List_Table
{
    ...
    {
        echo \wpautop(\__('No WP Desk plugins found.', 'flexible-shipping-dhl-express'));
    }
    ...
    {
        $columns = ['product_name' => \__('Plugin', 'flexible-shipping-dhl-express'), 'product_status' => \__('Subscription Status', 'flexible-shipping-dhl-express'), 'product_license' => \__('Subscription Data', 'flexible-shipping-dhl-express')];
        return $columns;
    }
    ...
    {
        $status = \__('Deactivated', 'flexible-shipping-dhl-express');
        if ($item['activation_status'] == 'Activated') {
            $status = \__('Activated', 'flexible-shipping-dhl-express');
        }
        return $status;
    }
