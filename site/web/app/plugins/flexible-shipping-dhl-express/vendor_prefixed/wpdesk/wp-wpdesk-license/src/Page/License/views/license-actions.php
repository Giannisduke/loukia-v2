...
<form method="POST">
    <table class="wpdesk_helper_key_table">
        <tr>
            <td><?php 
\_e('Key:', 'flexible-shipping-dhl-express');
?></td>
...
?> /></td>
        ...
        <tr>
            <td><?php 
\_e('Email:', 'flexible-shipping-dhl-express');
?></td>
...
if ($activation_status == 'Deactivated') {
    ...
    \_e('Activate', 'flexible-shipping-dhl-express');
    ?></button>
				<?php 
} else {
    ?>
                    <button class="wpdesk_helper_button button"><?php 
    \_e('Deactivate', 'flexible-shipping-dhl-express');
    ?></button>
				<?php 
}
?>
